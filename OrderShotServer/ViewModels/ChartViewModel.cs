    ...
    public class ChartViewModel
    {
        ...
        private void StrategyModel_PropertyChanged(object? sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            if (ChartModel.IsRun)
            {
                ...
                if (e.PropertyName == "PriceOpenOrder")
                {
                ...
                if (e.PropertyName == "PriceCloseOrder")
                {
                    if (StrategyModel.IsPositiveBet)
                    {
                        AddOrder(SymbolModel.TimeDouble, StrategyModel.PriceCloseOrder, Color.LightBlue, MarkerShape.filledDiamond);
                    }
                    else
                    {
                        AddOrder(SymbolModel.TimeDouble, StrategyModel.PriceCloseOrder, Color.Orange, MarkerShape.eks);
                    }
                }
                if (e.PropertyName == "TakeProfitOpenOrder")
                {
                ...
                if (e.PropertyName == "StopLossOpenOrder")
                {
                    if (StrategyModel.IsOpenOrder)
                    {
